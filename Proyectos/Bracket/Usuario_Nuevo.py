...
class ClaseUsuarioNuevo():
    def VentanaUsuarioNuevo(v_main,nom_usuario,id_bracket):
        ...
        Clase_Usuario_Nuevo.Grupos.LlenarGrupos(btn)
        ...
        if can_grupos == 8:
            ...
            Fase_4()
            Fase_5()
            Clase_Usuario_Nuevo.Grupos.AccionF1(btn,btn2)
            Clase_Usuario_Nuevo.Grupos.AccionF2(btn2,btn3)
            Clase_Usuario_Nuevo.Grupos.AccionF3(btn3,btn4)
            Clase_Usuario_Nuevo.Grupos.AccionF4(btn4,btn5)
            Clase_Usuario_Nuevo.Grupos.AccionF5(btn5,btn6)
            Clase_Usuario_Nuevo.Grupos.AccionFGanador8(btn,btn2,btn3,btn4,btn5,btn6,id_bracket,v_ganador,v_main)
        elif can_grupos== 4:
            Fase_1()
            Fase_2_4()
            Fase_3_4()
            ...
            Clase_Usuario_Nuevo.Grupos.AccionF5(btn4,btn5)
            
            Clase_Usuario_Nuevo.Grupos.AccionFGanador4(btn,btn2,btn3,btn4,btn5,id_bracket,v_ganador,v_main)
        elif can_grupos == 2:
            Fase_1_2()
            Fase_2_2()
            Fase_3_2()
            ...
            Clase_Usuario_Nuevo.Grupos.AccionF5(btn3,btn4)

            Clase_Usuario_Nuevo.Grupos.AccionFGanador2(btn,btn2,btn3,btn4,id_bracket,v_ganador,v_main)
