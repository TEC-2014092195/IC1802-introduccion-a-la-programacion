...
import Usuario_Nuevo
import Usuario_Registrado
            ...
            if ID.get()!="":
                ...
                if bandera == True :
                    ...
                    if Registro == "Nuevo":
                        ...
                        Usuario_Nuevo.ClaseUsuarioNuevo.VentanaUsuarioNuevo(v_main,nom_usuario,id_bracket)
                        
                    else:
                        ventana_usuario.destroy()
                        file.close()
                        
                        Usuario_Registrado.ClaseUsuarioRegistrado.VentanaUsuarioRegistrado(v_main,nom_usuario,id_bracket)
        ...
        try:
            ...
            if varIDBracketNew.get()!="" and varNombre.get()!="":
                ...
                if bandera == True :
                    ...
                    file.close()
                    file=open("Usuarios/Usuarios.txt","a")
