...
import Clases_Login_Admin
import Clases_Login_Usuario
...
btnAdmin.configure(command=lambda:Clases_Login_Admin.Administrador.ventana_admin(v_main))
...
btnUsuario.configure(command=lambda:Clases_Login_Usuario.Usuario.ventana_usuario(v_main))
