...
import Clases_Bracket_Ganador

class ClaseBracketGanador():
    def VentanaBracketGanador(v_main):
        v=Toplevel()

        
        v.geometry("1030x700+%d+0" %((v.winfo_screenwidth() - 1030) / 2))
        v.title("Bracket Ganador")
        ...
        btnA1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoA(btnOctA1,
                                              btnOctA2,
                                              btnA1.cget("text")))

        btnA2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoA(btnOctA1,
                                              btnOctA2,
                                              btnA2.cget("text")))

        btnA3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoA(btnOctA1,
                                              btnOctA2,
                                              btnA3.cget("text")))

        btnA4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoA(btnOctA1,
                                              btnOctA2,
                                              btnA4.cget("text")))
        ############################################grupoB#############
        btnB1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoB(btnOctB1,
                                              btnOctB2,
                                              btnB1.cget("text")))

        btnB2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoB(btnOctB1,
                                              btnOctB2,
                                              btnB2.cget("text")))

        btnB3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoB(btnOctB1,
                                              btnOctB2,
                                              btnB3.cget("text")))

        btnB4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoB(btnOctB1,
                                              btnOctB2,
                                              btnB4.cget("text")))

        ############################################grupoC#############

        btnC1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoC(btnOctC1,
                                              btnOctC2,
                                              btnC1.cget("text")))

        btnC2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoC(btnOctC1,
                                              btnOctC2,
                                              btnC2.cget("text")))

        btnC3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoC(btnOctC1,
                                              btnOctC2,
                                              btnC3.cget("text")))

        btnC4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoC(btnOctC1,
                                              btnOctC2,
                                              btnC4.cget("text")))

        ############################################grupoD#############

        btnD1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoD(btnOctD1,
                                              btnOctD2,
                                              btnD1.cget("text")))

        btnD2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoD(btnOctD1,
                                              btnOctD2,
                                              btnD2.cget("text")))

        btnD3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoD(btnOctD1,
                                              btnOctD2,
                                              btnD3.cget("text")))

        btnD4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoD(btnOctD1,
                                              btnOctD2,
                                              btnD4.cget("text")))

        ############################################grupoE#############

        btnE1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoE(btnOctE1,
                                              btnOctE2,
                                              btnE1.cget("text")))

        btnE2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoE(btnOctE1,
                                              btnOctE2,
                                              btnE2.cget("text")))

        btnE3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoE(btnOctE1,
                                              btnOctE2,
                                              btnE3.cget("text")))

        btnE4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoE(btnOctE1,
                                              btnOctE2,
                                              btnE4.cget("text")))

        ############################################grupoF#############

        btnF1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoF(btnOctF1,
                                              btnOctF2,
                                              btnF1.cget("text")))

        btnF2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoF(btnOctF1,
                                              btnOctF2,
                                              btnF2.cget("text")))

        btnF3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoF(btnOctF1,
                                              btnOctF2,
                                              btnF3.cget("text")))

        btnF4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoF(btnOctF1,
                                              btnOctF2,
                                              btnF4.cget("text")))

        ############################################grupoG#############

        btnG1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoG(btnOctG1,
                                              btnOctG2,
                                              btnG1.cget("text")))

        btnG2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoG(btnOctG1,
                                              btnOctG2,
                                              btnG2.cget("text")))

        btnG3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoG(btnOctG1,
                                              btnOctG2,
                                              btnG3.cget("text")))

        btnG4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoG(btnOctG1,
                                              btnOctG2,
                                              btnG4.cget("text")))

        ############################################grupoH#############

        btnH1.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoH(btnOctH1,
                                              btnOctH2,
                                              btnH1.cget("text")))

        btnH2.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoH(btnOctH1,
                                              btnOctH2,
                                              btnH2.cget("text")))

        btnH3.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoH(btnOctH1,
                                              btnOctH2,
                                              btnH3.cget("text")))

        btnH4.configure(command=lambda:Clases_Bracket_Ganador.AccionesOctavos.AccionGrupoH(btnOctH1,
                                              btnOctH2,
                                              btnH4.cget("text")))
        ...
        btnOctA1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctAyB1(btnCuartosA1,
                                              btnOctA1.cget("text")))

        btnOctB2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctAyB1(btnCuartosA1,
                                              btnOctB2.cget("text")))


        btnOctB1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctAyB2(btnCuartosB1,
                                              btnOctB1.cget("text")))

        btnOctA2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctAyB2(btnCuartosB1,
                                              btnOctA2.cget("text")))
        #############################BotonesC y D

        btnOctC1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctCyD1(btnCuartosC1,
                                              btnOctC1.cget("text")))

        btnOctD2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctCyD1(btnCuartosC1,
                                              btnOctD2.cget("text")))


        btnOctD1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctCyD2(btnCuartosD1,
                                              btnOctD1.cget("text")))

        btnOctC2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctCyD2(btnCuartosD1,
                                              btnOctC2.cget("text")))

        #############################Botones E y F

        btnOctE1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctEyF1(btnCuartosE1,
                                              btnOctE1.cget("text")))

        btnOctF2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctEyF1(btnCuartosE1,
                                              btnOctF2.cget("text")))


        btnOctF1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctEyF2(btnCuartosF1,
                                              btnOctF1.cget("text")))

        btnOctE2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctEyF2(btnCuartosF1,
                                              btnOctE2.cget("text")))

        #############################Botones G y H

        btnOctG1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctGyH1(btnCuartosG1,
                                              btnOctG1.cget("text")))

        btnOctH2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctGyH1(btnCuartosG1,
                                              btnOctH2.cget("text")))


        btnOctH1.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctGyH2(btnCuartosH1,
                                              btnOctH1.cget("text")))

        btnOctG2.configure(command=lambda:Clases_Bracket_Ganador.AccionesCuartos.AccionOctGyH2(btnCuartosH1,
                                              btnOctG2.cget("text")))
        ...
        btnCuartosA1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosAyB1(btnSemifinalA1,
                                              btnCuartosA1.cget("text")))




        btnCuartosB1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosAyB1(btnSemifinalA1,
                                              btnCuartosB1.cget("text")))


        #############################BotonesC y D

        btnCuartosC1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosCyD1(btnSemifinalB1,
                                              btnCuartosC1.cget("text")))




        btnCuartosD1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosCyD1(btnSemifinalB1,
        ...
        btnCuartosE1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosEyF1(btnSemifinalC1,
                                              btnCuartosE1.cget("text")))




        btnCuartosF1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosEyF1(btnSemifinalC1,
        ...
        btnCuartosG1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosGyH1(btnSemifinalD1,
                                              btnCuartosG1.cget("text")))




        btnCuartosH1.configure(command=lambda:Clases_Bracket_Ganador.AccionesSemifinal.AccionCuartosGyH1(btnSemifinalD1,
        ...
        btnSemifinalA1.configure(command=lambda:Clases_Bracket_Ganador.AccionesFinal.AccionSemifinalAyB1(btnFinalA1,
                                              btnSemifinalA1.cget("text")))



        btnSemifinalB1.configure(command=lambda:Clases_Bracket_Ganador.AccionesFinal.AccionSemifinalAyB1(btnFinalA1,
                                              btnSemifinalB1.cget("text")))



        btnSemifinalC1.configure(command=lambda:Clases_Bracket_Ganador.AccionesFinal.AccionSemifinalCyD1(btnFinalB1,
                                              btnSemifinalC1.cget("text")))



        btnSemifinalD1.configure(command=lambda:Clases_Bracket_Ganador.AccionesFinal.AccionSemifinalCyD1(btnFinalB1,
        ...
        btnFinalA1.configure(command=lambda:Clases_Bracket_Ganador.AccionesGanador.AccionFinalAyB1(btnGanador,
                                              btnFinalA1.cget("text")))



        btnFinalB1.configure(command=lambda:Clases_Bracket_Ganador.AccionesGanador.AccionFinalAyB1(btnGanador,
                                              btnFinalB1.cget("text")))


        btnGanador.configure(command=lambda:Clases_Bracket_Ganador.Confirmar.VerificarBracket(btnOctA1.cget("text"),
                                                                               btnOctB2.cget("text"),
                                                                               btnOctB1.cget("text"),
                                                                               btnOctA2.cget("text"),
        ##########################################################################                                                                    
        ...
        def cerrar_con_equis():
            messagebox.showinfo("BM","Debe Agregar los ganadores y continuar con el programa para cerrarlo")
